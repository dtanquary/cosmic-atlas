...
try{
 for(const engine of engines){
  ...
  try{
   ...
   await visit('NGC 3982');await tap('#inspector .mobile-sheet-toggle');check('exactDesiIdentityAvailable',await page.locator('#object-kind').isVisible()&&(await page.locator('#object-kind').textContent()).includes('39633325333155389'));
