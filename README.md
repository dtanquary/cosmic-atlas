...
| [`src/diagnostics.ts`](src/diagnostics.ts), [`src/ui-diagnostics.ts`](src/ui-diagnostics.ts), [`src/share-diagnostics.ts`](src/share-diagnostics.ts) | Development-only browser acceptance runners, including the shareable-view and travel checks |
