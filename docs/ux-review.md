...
State: fixing; Chrome and WebKit phone journeys pass, shared GPU and production regression review pending.

The previous 402×874 layout placed a 304×594 inspector over most of the map and kept the desktop icon rail. The new compact galaxy panel is approximately 130 px tall, with name, distance, Focus and Details. Expanded details occupy at most 58% of portrait height (capped at 480 px); the header actions remain fixed while content scrolls. Tours retain Prev/Play/Next with optional captions. A four-action bottom toolbar replaces the rail, and settings use three expandable groups. Initial phone captures confirm reachable controls and substantially more visible sky. Strict TypeScript, the existing 91 tests and the first 107 browser assertions pass. Chrome touch injection verifies orbit, pinch and pan through the public saved-camera flow. Chrome and WebKit cover 375×812, 402×874, 430×932 and 874×402 layouts, plus reduced-height search and repeated restoration to 1600×1000 desktop. These are browser simulations, not a physical iPhone check. Shared GPU suites and production checks remain to be completed.
