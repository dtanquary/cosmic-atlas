...
The intended Observer arrival is 60 kpc from the Solar System, looking toward the origin along an oblique disk view. Observer focus protects the Milky Way from incidental-obstruction fading; Overview and visits to other galaxies restore automatic behavior. Points-only still hides its volumes. The Sun marker stays at the origin while a Galaxy view can orbit the Galactic center.
